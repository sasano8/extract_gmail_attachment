...
def get_bucket_client(
    type: Literal["local", "minio"] = "local", bucket_name: str = "", **kwargs
):
    if not bucket_name:
        raise Exception()
...
class MinioBucket:
    ...
    def _write_bytes(self, __data: bytes, __dest, metadata: dict = {}):
        ...
        meta = {
            "X-Amz-Meta-User-Meta": base64.b64encode(
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            flow = InstalledAppFlow.from_client_secrets_file(
                requirement.YOUR_DOWNLOADED_JSON_FILE, SCOPES
            )
        ...
        for message in get_message_ids(service, start_date, end_date):
            ...
            for part in msg["payload"]["parts"]:
                if "filename" in part and part["filename"]:
                    ...
                    filename = (
                        info["domain"] + "/" + info["date"] + "_" + info["filename"]
                    )
...
def get_sample_message():
    return [
        ...
        {
            "name": "Subject",
            "value": "[ Remogu ] 請求書 に Remoguカスタマーサクセス がコメントしました",
        },
        {"name": "Date", "value": "Tue, 03 Oct 2023 05:10:49 +0000"},
        {"name": "Delivered-To", "value": "xxx@xxx.com"},
        {
            "name": "Received",
            "value": "by 2002:a05:6a10:a178:b0:4e4:2a6b:18e8 with SMTP id r24csp1908322pxe;        Mon, 2 Oct 2023 22:10:49 -0700 (PDT)",
        },
        {
            "name": "X-Google-Smtp-Source",
            "value": "AGHT+IGcaPparQSWr4XdN3DAS4akPA5v8dB7B1E9AEyolJeQcwLI4VUD8ogJFMX9Vg8pMNf7tTF3",
        },
        {
            "name": "X-Received",
            "value": "by 2002:a05:6902:1028:b0:d11:2a52:3f35 with SMTP id x8-20020a056902102800b00d112a523f35mr14131144ybt.20.1696309849593;        Mon, 02 Oct 2023 22:10:49 -0700 (PDT)",
        },
        {
            "name": "ARC-Seal",
        ...
        },
        {
            ...
            "value": "i=1; mx.google.com;       dkim=pass header.i=@sender.work header.s=mandrill header.b=jAnQP1TG;       dkim=pass header.i=@mandrillapp.com header.s=mandrill header.b=UhDGDOpf;       spf=pass (google.com: domain of bounce-md_31165128.651ba259.v1-5b4056df89a0489896e58a7a87a57db6@mandrillapp.com designates 205.201.139.5 as permitted sender) smtp.mailfrom=bounce-md_31165128.651ba259.v1-5b4056df89a0489896e58a7a87a57db6@mandrillapp.com",
        },
        {
            "name": "Return-Path",
            "value": "<bounce-md_31165128.651ba259.v1-5b4056df89a0489896e58a7a87a57db6@mandrillapp.com>",
        },
        {
            "name": "Received",
            "value": "from mail5.wdc04.mandrillapp.com (mail5.wdc04.mandrillapp.com. [205.201.139.5])        by mx.google.com with ESMTPS id 64-20020a250343000000b00d86822c0a4asi260151ybd.81.2023.10.02.22.10.49        for <xxx@xxx.com>        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);        Mon, 02 Oct 2023 22:10:49 -0700 (PDT)",
        },
        {
            "name": "Received-SPF",
            "value": "pass (google.com: domain of bounce-md_31165128.651ba259.v1-5b4056df89a0489896e58a7a87a57db6@mandrillapp.com designates 205.201.139.5 as permitted sender) client-ip=205.201.139.5;",
        },
        {
        ...
        {
            "name": "Received",
            "value": "from pmta16.mandrill.prod.suw01.rsglab.com (localhost [127.0.0.1]) by mail5.wdc04.mandrillapp.com (Mailchimp) with ESMTP id 4S05WF317tzG0DCxp for <xxx@xxx.com>; Tue,  3 Oct 2023 05:10:49 +0000 (GMT)",
        },
        {
            "name": "DKIM-Signature",
        ...
        {
            "name": "Received",
            "value": "from [18.181.134.114] by mandrillapp.com id 5b4056df89a0489896e58a7a87a57db6; Tue, 03 Oct 2023 05:10:49 +0000",
        },
        {
            "name": "Message-Id",
            "value": "<651ba259521_7189c4538477@ip-172-16-0-54.ap-northeast-1.compute.internal.mail>",
        },
        {"name": "To", "value": "xxx@xxx.com"},
        {"name": "X-Native-Encoded", "value": "1"},
        {
            "name": "X-Report-Abuse",
            "value": "Please forward a copy of this message, including all headers, to abuse@mandrill.com. You can also report abuse here: https://mandrillapp.com/contact/abuse?id=31165128.5b4056df89a0489896e58a7a87a57db6",
        },
        ...
        {
            "name": "Content-Type",
            "value": 'multipart/alternative; boundary="_av-DFtau-wklHuLxQyIVZgMjg"',
        },
    ]
    ...
    return {
        ...
        "headers": [
            ...
            {"name": "Content-Description", "value": "image001.png"},
            {
                ...
                "value": 'inline; filename="image001.png"; size=258363; creation-date="Wed, 28 Jun 2023 07:46:17 GMT"; modification-date="Wed, 28 Jun 2023 07:46:18 GMT"',
            },
...
if __name__ == "__main__":
    pipeline = Pipeline.create_pipeline(
        ...
        # extractors=[]
        pipelines=[ignore_ics.__name__, ignore_domain.__name__],
        # credentials=[]
    )
    ...
    for filename, file_data, info in service.get_attachments(
