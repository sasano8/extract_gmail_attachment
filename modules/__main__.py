...
def parse_arguments():
    ...
    # オプションの定義
    parser.add_argument("--protocol", "-p", type=str, default="file", help="fsspec がサポートするプロトコル")
    parser.add_argument("--output_dir", "-o", type=str, default=".cache", help="出力ファイルのパス")
    parser.add_argument("--clean", "-c", type=convert_str_to_bool, default=False, help="ディレクトリをクリーンアップする")
    parser.add_argument("--pipelines", help="実行するパイプラインの順序をカンマ区切りで指定する")
